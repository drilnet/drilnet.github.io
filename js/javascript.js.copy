...
function LoadBook()
{
	...
	var ArrayBook = [
		...
		+ "<br>"
		+ "<br>"
		+ "В брошюре приведены формулы, номограммы и примеры расчётов, наиболее часто встречающиеся в практике радиолюбителя. "
		+ "<br>"
		+ "Специальная глава посвящена недавно введёной международной системе единиц."
		+ "<br>"
