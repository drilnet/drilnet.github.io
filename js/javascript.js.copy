...
function LoadBook()
{
	...
	var ArrayBook = [
		...
		+ "<br>"
		+ "и даются указания, как самому сделать некоторые радиолюбительские приборы. Книгу можно использовать "
		+ "<br>"
		+ "в качестве пособия в кружках по радиоэлектронике, а также для саммообразования.",
		...
		+ "<br>"
		+ "<br>"
		+ "В брошюре приведены формулы, номограммы и примеры расчётов, наиболее часто встречающиеся "
		+ "<br>"
		+ "в практике радиолюбителя. Специальная глава посвящена недавно введёной международной "
		+ "<br>"
		+ "системе единиц. Предназначена брошюра для широкого круга радиолюбителей.",
	...
	temp += "<span style=\"font-size: 0.8em;\">";
		...
		temp += "<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\">";
			...
			temp += "<b>Уважаемые создатели!</b>";
			temp += "</td>";
			temp += "</tr>";

			temp += "<tr>";
			temp += "<td align=\"center\">";
			temp += "Спасибо Вам за литературу!";
			temp += "</td>";
			temp += "</tr>";
