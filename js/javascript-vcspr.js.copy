...
function VCSPRReset256x256()
{
	var temp = "<a href=\"https://gfto.ru/index/konstruktor_3d_teksta/0-37\" title=\"Надпись сделана: https://gfto.ru (нажмите, откроется в новой вкладке)\" target=\"_blank\">";
		temp += "<img class=\"icon\" src=\"images-sprgrf/imageSPR.png\">";
			temp += "</a>";
...
//
// Получаем RGB.
// Перекодировка, цвет Вектор'а в цвет PC-компьютер'а.
//
function VCGetRGB(color)
{
	...
	// Цвета Вектор-06Ц через цвета PC компьютер'а.
	// Массивы цветов PC-компьютер'а.
